...
export default {
    ...
    mounted(){
        ...
        this.axios.get('/ajax/movieOnInfoList?token=&optimus_uuid=CC455C20007611EABBD27914170544287AD9471BBA0C46A0AAD0C34C205B652E&optimus_risk_level=71&optimus_code=10').then((res)=>{
...
.detail_player .swiper-slide img{ width:90px; margin-bottom: 5px;height: 66px;}
